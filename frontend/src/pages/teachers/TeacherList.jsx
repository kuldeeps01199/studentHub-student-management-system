...
const TeacherList = () => {
    ...
    return (
        <div className="space-y-6 relative">
                        ...
                        <tbody className="divide-y divide-slate-100">
                            {loading ? (
                                ...
                                filteredTeachers.map((teacher) => {
                                    const isSelf = String(teacher.user?._id || teacher.user) === String(user?._id);
                                    ...
                                    return (
                                        <tr key={teacher._id} className="hover:bg-slate-50/80 transition-colors">
                                            ...
                                            <td className="p-4">
                                                {canViewFull && teacher.employeeId ? (
            ...
            {/* View Teacher Modal */}
            {viewingTeacher && (() => {
                const isSelfModal = String(viewingTeacher.user?._id || viewingTeacher.user) === String(user?._id);
                const canViewModalFull = isAdmin || (user?.role === 'teacher' && isSelfModal);
                        ...
                        <div className="bg-white rounded-2xl p-6 w-full max-w-lg shadow-xl border border-slate-100 relative max-h-[90vh] overflow-y-auto">
                            ...
                            <div className="flex items-center space-x-4 mb-6">
                                ...
                                <div>
                                    ...
                                    {canViewModalFull && viewingTeacher.employeeId && (
                                    ...
                                    <span className="inline-block mt-1 px-2.5 py-0.5 rounded-full text-[10px] font-bold bg-emerald-100 text-emerald-700">
                                        {canViewModalFull ? (viewingTeacher.designation || 'Faculty Member') : 'Faculty Member'}
                                    </span>
                                </div>
                            </div>
