...
const ReportCard = () => {
    ...
    useEffect(() => {
        const fetchStudentData = async () => {
            try {
                ...
                let currentStudent = studentsData.find(s => String(s.user?._id || s.user) === String(userId));
    ...
    return (
        <div className="max-w-4xl mx-auto space-y-6">
            ...
            <div className="flex items-center justify-between bg-white p-4 sm:p-5 rounded-2xl border border-slate-200/80 shadow-sm print:hidden">
                <div>
                ...
                <div className="flex items-center space-x-3">
                    <button
                        onClick={handlePrint}
                        className="bg-indigo-600 hover:bg-indigo-700 text-white px-5 py-2.5 rounded-xl font-semibold text-sm flex items-center space-x-2 shadow-sm transition-all active:scale-95"
                    >
                        <Printer size={16} />
                ...
                <div className="bg-slate-50 rounded-xl p-5 border border-slate-200/60">
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 text-xs">
                        <div>
                            ...
                            <span className="font-bold text-slate-900 text-sm">{studentProfile?.fullName || user?.name || 'N/A'}</span>
                        </div>
                        <div>
